...
struct PicturesRegistration: View {
    ...
    @StateObject private var imageService = ImageApiService(user: UserDataService.shared.getCurrentUser()!)
        ...
        VStack {
                    ...
                    Button("Upload Image") {
                        if let image = selectedImage {
                            imageService.updateUserProfileImage(image: image)
